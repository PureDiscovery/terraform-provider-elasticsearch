	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"action_auto_create_index": {
				Type:         schema.TypeString,
				Optional:     true,
				ValidateFunc: validation.StringMatch(regexp.MustCompile(`^(true|false|\.?[a-z0-9][a-z0-9_-]*(\.[a-z0-9][a-z0-9_-]*)*\*?)$`), "expected value to be one of: true, false or comma-separated list"),
